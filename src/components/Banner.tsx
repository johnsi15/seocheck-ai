...
export function Banner() {
  ...
  return (
    <div
      id='sticky-banner'
      tabIndex={-1}
      className='fixed bottom-0 start-0 z-50 flex justify-between px-2 py-2 w-full md:p-4 border-t border-gray-400 bg-slate-300 dark:bg-blue-950 dark:border-gray-800 gap-1 md:gap-0'
    >
